...
function SearchAPIKeysDataCollection() {
  ...
  return (
    <div className="px-4 pt-4 pb-1">
      <p className="font-lato font-bold text-lg pb-2 dark:text-gray-300">
        {" "}
        Search only API Key
      </p>
      ...
      <div className="flex gap-2 mb-4 items-center">
        <select
          name="expiry"
          id="expiry"
          className="outline-none rounded-md border-2 p-1 w-44 font-lato text-gray-500 dark:bg-[#010409] dark:border-gray-600"
      ...
      <p className="font-lato font-bold text-sm mt-3 dark:text-gray-400">
        {" "}
        Select Scopes
      </p>
      <p className="font-lato text-gray-500 text-sm pb-2 dark:text-gray-500">
        {" "}

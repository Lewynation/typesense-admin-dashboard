...
function AddAliasesModal() {
  ...
  return (
    <ModalBackground>
      <div className="bg-white rounded-md p-4 w-3/5 ">
        <div className="flex justify-between items-center mb-1">
          <div className="flex gap-1 items-start">
            <p className="font-bold font-lato text-lg">Add Alias</p>
            <a
        ...
        <input
          type="text"
          className="outline-none rounded-md border-2 p-1 w-full mb-3 font-lato text-gray-500"
